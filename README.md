...
the player is still reading and they come back to a turn that already happened. They don't celebrate the computer either: the roll-out, Score-B
...
All six set aside is a **rollout**. Six for six scores nothing on its own: the
dice come back, the turn rolls on by itself after the roll-out or colour coded
screen has played, and the points only count once the player finishes their next
rolls and stops.
...
and another 50 for every 2,500 scored — 450 once you pass 2,500, 500 past
5,000, and so on. Crossing one of those is a **Score-B**, and it gets a
